...
This Azure Automation Runbook automates the backup of items in an Azure Key Vault to blob storage and deletes previous backups older than retention date.
